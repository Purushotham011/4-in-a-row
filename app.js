...
let playerTurn = RED_TURN; // 1 - red, 2 - blue
let hoverColumn = -1;
let animating = false;
...
function updateBackgroundColor() {
  ...
  setTimeout(() => {
    ...
    if (playerTurn === RED_TURN) {
      document.body.style.backgroundColor = "rgba(240, 40, 40, 0.8)";
      playerTurnDisplay.textContent = "Player Turn: Red";
    } else {
      document.body.style.backgroundColor = "rgba(59, 90, 190, 0.77)";
      playerTurnDisplay.textContent = "Player Turn: Blue";
    }
